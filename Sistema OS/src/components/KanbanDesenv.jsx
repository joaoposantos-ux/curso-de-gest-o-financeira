...
const columnStyles = {
  'Fila Desenv': 'bg-yellow-50 border-yellow-200',
  'Em Desenv': 'bg-blue-50 border-blue-200',
  'Teste': 'bg-purple-50 border-purple-200',
...
function KanbanDesenv({ osList, onDragEnd, usuario, onUpdateOs, osIdSelecionadaInicial }) {
  ...
  const columns = ['Fila Desenv', 'Em Desenv', 'Teste', 'Concluído'];
