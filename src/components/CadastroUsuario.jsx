...
const API_URL = import.meta.env.VITE_API_URL;
  ...
  body: formData,
    ...
    setMsg(data.error ? data.error : 'Usuário cadastrado!');
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-300">
      ...
      >
        ...
        />
        <button
          className="bg-green-600 text-white px-4 py-2 rounded w-full font-semibold shadow hover:bg-green-700 transition mb-2"
        >
          Cadastrar
        </button>
